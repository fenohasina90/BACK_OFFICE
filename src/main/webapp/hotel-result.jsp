            ...
            <div class="page-content">
                <% if (success) { %>
                    ...
                    <div class="result-actions">
                        <a href="<%= request.getContextPath() %>/hotel/liste" class="btn btn-primary">Retour à la liste</a>
                        <a href="<%= request.getContextPath() %>/hotel/formulaire" class="btn btn-secondary">Ajouter</a>
                    </div>
                <% } else { %>
                    ...
                    <div class="result-actions">
                        <a href="<%= request.getContextPath() %>/hotel/liste" class="btn btn-secondary">Retour</a>
                    </div>
                <% } %>
            </div>
        </main>
